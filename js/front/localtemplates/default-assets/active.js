(function ($) {
    ...
    $(document).ready(function(){
        ...
        $('#preloader').delay(300).fadeOut(300, function () {
            $(this).remove();
        });
        setTimeout(loadInit, loadTime);
    });

    function loadInit () {
        $("body").removeClass("animation").addClass("animation_start");
    }
    ...
    if ($.fn.owlCarousel) {
        ...
        $('.welcome-area .owl-carousel').owlCarousel({
            loop: true,
            autoplay: true,
            smartSpeed: 1500,
            animateIn: 'fadeIn',
    ...
    uza_window.on('scroll', function () {
        ...
        //     if ($('.main-header-area').hasClass("sticky")) {
        //         setTimeout(() => $('.main-header-area').addClass('sticky_up'), 500);
        //     }
        // } else {
        //     $('.main-header-area').removeClass('sticky sticky_up');
        // }
    });
